...
{
    public static class OrmLiteConnReadExtensions
    {
        ...
        public static void SetFilters<T>(this IDbConnection dbConn, object anonType, bool excludeNulls)
        {
            dbConn.Exec(dbCmd => dbCmd.SetFilters<T>(anonType, excludeNulls));
        }

        public static void SetFilters<T>(this IDbConnection dbConn, object anonType)
        {
            dbConn.Exec(dbCmd => dbCmd.SetFilters<T>(anonType));
        }

        public static void ClearFilters(this IDbConnection dbConn)
        {
            dbConn.Exec(dbCmd => dbCmd.ClearFilters());
        }
        ...
        public static IEnumerable<T> QueryEach<T>(this IDbConnection dbConn, string sql, object anonType = null)
            where T : new()
        {
            return dbConn.Exec(dbCmd => dbCmd.QueryEach<T>(sql, anonType));
        }

        public static IEnumerable<T> EachWhere<T>(this IDbConnection dbConn, object anonType)
            where T : new()
        {
            return dbConn.Exec(dbCmd => dbCmd.EachWhere<T>(anonType));
        }
