...
namespace ServiceStack.OrmLite.Oracle
{
    public class OracleDataReader : DbDataReader
    {
        ...
        {
            var oracleValue = new OracleValue(GetOracleValueRaw(ordinal));
        ...
        public override object GetValue(int ordinal)
        {
            ...
            if (dataTypeName == "TimeStampTZ")
            {
                value = GetOracleValueRaw(ordinal);
            }

            return value ?? _reader.GetValue(ordinal);
        }

        private object GetOracleValueRaw(int ordinal)
        {
            return GetOracleValueMethod != null 
        ...
        private MethodInfo GetOracleValueMethod
        {
            get
            {
                return _readerType.GetMethod("GetOracleValue", BindingFlags.Public | BindingFlags.Instance);
            }
        }
