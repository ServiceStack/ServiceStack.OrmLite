...
namespace ServiceStack.OrmLite.VistaDB5.Tests.UseCase
{
    ...
    public class SimpleUseCase
    {
        ...
        public void TestFixtureSetUp()
        {
            ...
            OrmLiteConfig.DialectProvider = new VistaDB5DialectProvider();
        }
        ...
        public void Simple_CRUD_example()
        {
            ...
            var sqlServerFactory = new OrmLiteConnectionFactory(connStr, VistaDB5DialectProvider.Instance);
