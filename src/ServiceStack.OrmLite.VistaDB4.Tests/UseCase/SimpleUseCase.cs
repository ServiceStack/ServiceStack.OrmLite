...
namespace ServiceStack.OrmLite.VistaDB4.Tests.UseCase
{
    ...
    public class SimpleUseCase
    {
        ...
        public void TestFixtureSetUp()
        {
            ...
            OrmLiteConfig.DialectProvider = new VistaDB4DialectProvider();
        }
        ...
        public void Simple_CRUD_example()
        {
            ...
            var sqlServerFactory = new OrmLiteConnectionFactory(connStr, VistaDB4DialectProvider.Instance);
