...
namespace ServiceStack.OrmLite.VistaDB4.Tests
{
    public class OrmLiteTestBase
    {
        ...
        public void TestFixtureSetUp()
        {
            ...
            var dataFileName = Path.Combine(Path.GetTempPath(), Guid.NewGuid().ToString() + ".vdb4");
            var sourceStream = typeof(OrmLiteTestBase).Assembly
                .GetManifestResourceStream("ServiceStack.OrmLite.VistaDB.Tests.Resources.test.vdb4");
